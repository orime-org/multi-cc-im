...
For the full diff, see `git log packages/im-wechat/lib/ilink/`. When syncing, if upstream changes any of these 7 patch points, those changes need to be merged manually so we keep the strict-TS shape and Node-22+ fetch compatibility.
