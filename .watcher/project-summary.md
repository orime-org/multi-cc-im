...
# 项目阶段
**v0.2.x alpha personal-tool** — 单人 use case 真账号验证迭代中。开源 MIT，已发布 npm（`multi-cc-im` package，当前 latest = `0.2.1`，2026-05-26 publish — 含 codex CLI 适配 + 4 步启动向导 + 双 CLI 共存 + 飞书 post 类型支持 + 多图序号 anchor 协议）。
